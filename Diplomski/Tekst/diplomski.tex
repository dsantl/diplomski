...
\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Slike/aa/agent_alg_move_good.png}
	\caption{Parametar ostajanja na čvoru $0.01$ -- Kansai-C}
	\label{fig:agent_alg_move_good}
\end{figure}

\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Slike/aa/agent_alg_move_bad.png}
...
\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Slike/aa/agent_alg_big_rnd.png}
	\caption{Parametar pomaka na slučajni čvor $0.01$ -- Kansai-C}
	\label{fig:agent_alg_big_rnd}
\end{figure}

\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Slike/aa/agent_alg_small_rnd.png}
...
\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Slike/sa/sa_ideal.png}
...
\section{Minimizacija postotka promjenjenih čvorova}
...
\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Slike/test_65_1_iter_err_.png}
	\caption{Graf r250.5 - korištenje $65$ boja sa simuliranim kaljenjem}
	\label{fig:r250.5-65}
\end{figure}

\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Slike/test_67_1_iter_err_.png}
	\caption{Graf r250.5 - korištenje $67$ boja sa simuliranim kaljenjem}
	\label{fig:r250.5-67}
\end{figure}

\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Slike/test_69_1_iter_err_.png}
...
\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Slike/test_234_1_iter_err_.png}
	\caption{Graf r1000.5 - korištenje $234$ boja sa simuliranim kaljenjem}
	\label{fig:r1000.5-234}
\end{figure}

\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Slike/test_266_1_iter_err_.png}
	\caption{Graf r1000.5 - korištenje $266$ boja sa simuliranim kaljenjem}
	\label{fig:r1000.5-266}
\end{figure}

\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Slike/test_270_1_iter_err_.png}
...
\textbf{Broj agenata} važan je parametar, ali i kritičan parametar u smislu korištenja vremena. Ako ima više agenata konvergencija algoritma je bolja. Za praktične svrhe preporučuje se da broj agenata bude između jedne četvrtine broja čvorova i jedne polovine broja čvorova.

\textbf{Vjerojatnost ostajanja agenta na trenutnom čvoru} mora biti veoma mala. Što je vjerojatnost veća, to algoritam sporije konvergira. Ne preporučuje se premala vrijednost (tj. $0$), jer tada se gubi svojstvo preispitivanja odluke, što daje lošje rezultate. Na slici \ref{fig:agent_alg_move_good} prikazan je rad algoritma kada je vrijednost parametra relativno mala, za razliku od slike \ref{fig:agent_alg_move_bad}, gdje je vrijednost parametra relativno velika. Ne primjećuje se velika razlika, ali vidljiva je brža konvergencija u slučaju kada parametar ima manju vrijednost.
...
\subsection{Minimizacija postotka promjenjenih čvorova}
...
Glavna stavka rada s metaheuristikama je pogađanje dobrih parametara. Pokazuje se da su ključni samo neki parametri u radu metaheuristika. Najveća ovisnost parametara je s gustoćom grafa. Važno je koristiti vrste bojenja koje minimiziraju lokalnu pogrešku i koje mogu pretraživati veći prostor stanja. Ako postoje dvije vrste bojenja čvorova čiji se rezultati ne razlikuju za red veličine, tada treba koristiti onu koja koristi manje vremena.
...
\kljucnerijeci{bojanje grafova, metaheursitka, strojno učenje, regresija, simulirano kaljenje, evolucijska strategija, genetsko kaljenje, agentski algoritam}
\end{sazetak}
