...
Testiranje se obavljalo nad nekim primjerima iz DIMACS baze.
...
\begin{enumerate}
\item Uvijek je bolje koristiti migraciju a ne izolaciju. Za neke operatore može se odrediti najbolji parametar migracije (Transposition mutacija), dok za većinu drugih to nije pronađeno.
...
Razbija se simetrija u klasičnom problemu bojanja grafova. Tj. različite jedinke mogu predstavljati isto pobojane grafove. Problem se pokušava rješitit tako  što se na početku fiksiraju boje za određene čvorove. U našem problemu članak se može koristiti kod pristupa pri pohlepnom algoritmu.
...
\subsection{Testiranje metaheuristika}
...
\begin{table}[htb]
	\caption{Popis grafova za testiranje}
	\label{tbl:random-test}
	\centering
	\begin{tabular}{|l|c|c|c|c|} \hline
	Naziv grafa & Broj čvorova & Broj bridova & Inicijalna pogreška & Slučajno bojanje\\ \hline \hline
	graph\_38301107 & 700 & 489300 & $2.26\cdot 10^{09}$ &$4.40\cdot 10^{07}$ \\ \hline 
	graph\_75806963 & 700 & 489300 & $2.11\cdot 10^{09}$ &$4.59\cdot 10^{07}$ \\ \hline 
	graph\_2105155221 & 700 & 489300 & $1.94\cdot 10^{09}$ &$4.52\cdot 10^{07}$ \\ \hline 
	graph\_1259253950 & 700 & 489300 & $2.04\cdot 10^{09}$ &$4.66\cdot 10^{07}$ \\ \hline 
	graph\_1065301380 & 700 & 489300 & $2.21\cdot 10^{09}$ &$4.57\cdot 10^{07}$ \\ \hline 
	graph\_2144584312 & 500 & 249500 & $1.58\cdot 10^{09}$ &$2.44\cdot 10^{07}$ \\ \hline 
	graph\_596114851 & 500 & 249500 & $1.57\cdot 10^{09}$ &$2.47\cdot 10^{07}$ \\ \hline 
	graph\_1195753610 & 500 & 249500 & $1.39\cdot 10^{09}$ &$2.39\cdot 10^{07}$ \\ \hline 
	graph\_598677215 & 500 & 249500 & $1.40\cdot 10^{09}$ &$2.28\cdot 10^{07}$ \\ \hline 
	graph\_1367025351 & 500 & 249500 & $1.70\cdot 10^{09}$ &$2.48\cdot 10^{07}$ \\ \hline 
	graph\_1371311789 & 900 & 809100 & $2.85\cdot 10^{09}$ &$7.63\cdot 10^{07}$ \\ \hline 
	graph\_1707332235 & 900 & 809100 & $2.87\cdot 10^{09}$ &$7.69\cdot 10^{07}$ \\ \hline 
	graph\_1878030959 & 900 & 809100 & $2.72\cdot 10^{09}$ &$7.30\cdot 10^{07}$ \\ \hline 
	graph\_2056239330 & 900 & 809100 & $2.67\cdot 10^{09}$ &$7.38\cdot 10^{07}$ \\ \hline 
	graph\_1067592528 & 900 & 809100 & $2.60\cdot 10^{09}$ &$7.43\cdot 10^{07}$ \\ \hline 
	Kansai-C & 8937 & 2259249 & $1.68\cdot 10^{07}$ &$7.09\cdot 10^{08}$ \\ \hline 
	Tokai-B & 4244 & 915283 & $1.29\cdot 10^{09}$ &$2.41\cdot 10^{08}$ \\ \hline 
	Tokai-A & 17066 & 5298396 & $1.83\cdot 10^{10}$ &$9.51\cdot 10^{08}$ \\ \hline 
	Kansai-B & 4925 & 1283991 & $7.32\cdot 10^{07}$ &$3.21\cdot 10^{08}$ \\ \hline 
	Tokai-C & 10518 & 2557187 & $5.75\cdot 10^{09}$ &$5.53\cdot 10^{08}$ \\ \hline 
	Kansai-A & 18807 & 7359859 & $4.69\cdot 10^{09}$ &$1.41\cdot 10^{09}$ \\ \hline 
	\end{tabular}
\end{table}
