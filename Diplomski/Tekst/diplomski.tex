...
\textbf{Vjerojatnost ostajanja agenta na trenutnom čvoru} mora biti veoma mala. Što je vjerojatnost veća, to algoritam sporije konvergira. Ne preporuča se premala vrijednost (tj. $0$), jer tada se gubi svojstvo preispitivanja odluke, što daje lošje rezultate.

\textbf{Vjerojatnost pomaka agenta na slučajni čvor u susjedstvu} mora biti manja od $0.5$ da bi se dobili očekivani rezultati. Preporučena vrijednost je $0.3$.
...
\textbf{Faktor smanjenja temperature} treba imati relativno veliku vrijednost u intervalu $\in[0,1]$. Potrebno je smanjivati temperaturu, ali istovremeno paziti da temperatura ne padne prebrzo. Parametar je vezan za ukupan broj iteracija.

\textbf{Vjerojatnost lokalne vrste bojanja} je važan parametar koji treba postaviti tako da se osigura dovoljan broj minimizacija, ali istovremeno da se omogući pretraživanje lošjih rješenja. Pokazuje se da parametar mora biti veći od $0.5$ i preporuča se da bude manji od $0.9$.
