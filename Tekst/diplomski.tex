...
Problem odluke da li je graf \textbf{k-obojiv} spada u klasu \textbf{NP-potpunih} problema. Traženje kromatskog broja grafa $a$ spada u klasu \textbf{NP-teških} problema. Dokazi se mogu pronaći u \cite{Garey:1974:SNP:800119.803884}. Potrebno je pokazati da postavljen optimizacijski problem bojanja grafa spada u klasu \textbf{NP-teških} problema. Problem sigurn ne može spadati u druge spomenute klase zato jer to nije problem odluke.

...

Iako je problem NP-potpun za odluku može imati više stanja... a ekvivalentni problem NP-hard ima više stanja (nejednakost u sumi).

Heuristicke postupke jer optimizacija ne mora biti minimalna samo kvaliteta bolja.
...

\subsection{Posljedica "\emph{No free lunch}" teorema}

Dokazati da ako imamo ograničenu domenu da je to isto konačno i ovisi eksponencijalno i da se puno ne mjenja. Pogledati članak o free lunch teoremu i malo pisati o tome.
